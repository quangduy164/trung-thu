...
function finishDeathScene(){setTimeout(()=>{filmEl.classList.add('fade-black');setTimeout(()=>{filmEl.classList.remove('fade-black');document.querySelector('#end').classList.remove('show');intro.classList.remove('hide');document.querySelector('.intro .card h1').innerHTML='Sao bé nhát thế';document.querySelector('.intro .card p').innerHTML='';document.querySelector('#start').textContent='Cho bé 1 cơ hội nữa';chapter2Intro=true;started=false;ready=false},1900)},5000)}
