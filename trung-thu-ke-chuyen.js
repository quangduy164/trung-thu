...
const wishLetter=document.createElement('section');wishLetter.className='wish-letter';wishLetter.setAttribute('aria-label','Bức thư chúc Trung Thu');wishLetter.innerHTML=`<div class="wish-envelope" aria-hidden="true"><span>💌</span></div><article><img class="wish-gif wish-gif-left" src="kitty-roll.gif" alt="Mèo cuộn tròn"><img class="wish-gif wish-gif-right" src="sleepy-cat-cute-cat.gif" alt="Mèo buồn ngủ"><small>GỬI BẠN NHỎ</small><p>${WISH_MESSAGE}</p></article>`;filmEl.appendChild(wishLetter);
document.head.insertAdjacentHTML('beforeend',`<style>
