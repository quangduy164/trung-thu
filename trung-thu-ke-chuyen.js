...
#film[data-chapter="2"][data-beat="wish"] .stars,#film[data-chapter="2"][data-beat="wish"] .moon{opacity:0!important}
#film[data-chapter="2"][data-beat="wish"] .moon-orb{display:none!important;opacity:0!important;animation:none!important}
...
.wish-letter article{position:relative;width:min(88vw,520px);padding:22px 38px 70px;border:1px solid #e9b95b99;border-radius:8px;background:linear-gradient(145deg,#fffaf0,#f8e8c8);color:#50322e;text-align:center;box-shadow:0 24px 70px #000b,0 0 34px #ffd56f44;transform-origin:center bottom;animation:letterOpen 1.15s .25s cubic-bezier(.2,.8,.2,1) both}
.wish-gif{position:absolute;width:90px;height:90px;object-fit:contain;border-radius:14px;filter:drop-shadow(0 5px 5px #6b3b2b44);z-index:2}.wish-gif-left{left:6px;bottom:18px;transform:rotate(-6deg)}.wish-gif-right{right:6px;top:18px;transform:rotate(6deg)}
...
.wish-letter small{display:block;margin-bottom:28px;color:#a66a36;font-size:.55rem;font-weight:800;letter-spacing:.24em}.wish-letter h2{margin:10px 0 15px;font:700 clamp(1.25rem,3vw,1.85rem) 'Be Vietnam Pro',sans-serif;color:#6c3544}.wish-letter p{margin:0;line-height:1.75;font-size:clamp(.9rem,2vw,1.05rem);padding:0 72px}.wish-letter em{display:block;margin-top:20px;color:#995b55;font-family:serif;font-size:1rem}.wish-envelope{position:absolute;z-index:2;left:50%;top:50%;font-size:4.3rem;filter:drop-shadow(0 10px 12px #0008);animation:envelopeReveal 1s ease both}.wish-envelope span{display:block}
...
@media(max-width:680px){#film[data-chapter="2"][data-beat="wake"] .actors,#film[data-chapter="2"][data-beat="wish"] .actors{left:3%!important}#film[data-chapter="2"][data-beat="wake"] .firefly,#film[data-chapter="2"][data-beat="wish"] .firefly{left:22%!important}.wish-letter{padding:72px 14px 28px}.wish-letter article{width:min(92vw,420px);padding:20px 22px 52px}.wish-letter p{padding:0 48px}.wish-envelope{font-size:3.5rem}.wish-gif{width:64px;height:64px}.wish-gif-left{left:4px;bottom:12px}.wish-gif-right{right:4px;top:12px}}
</style>`);
document.head.insertAdjacentHTML('beforeend',`<style>
